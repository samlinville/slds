...
export function RecentTransactions() {
  return (
    <Card className="@container/transactions">
      ...
      <CardContent className="[&_td:nth-child(2)]:min-w-0 [&_td:nth-child(3)]:hidden @md/transactions:[&_td:nth-child(3)]:table-cell [&_td:nth-child(4)]:whitespace-nowrap [&_td:nth-child(5)]:hidden @lg/transactions:[&_td:nth-child(5)]:table-cell">
        <Table>
          <TableBody>
            <TableRow>
